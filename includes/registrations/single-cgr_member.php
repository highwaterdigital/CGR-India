<?php
/**
 * Template: Single CGR Member Profile
...
while ( have_posts() ) : the_post();
    ...
    $role = get_post_meta( get_the_ID(), '_cgr_role_type', true );
...
<main id="primary" class="site-main">
    ...
    <div class="profile-container">
            ...
            <div class="profile-contact-box">
                <?php if($desig): ?>
                    <div class="contact-item">
                        ...
                        <span><strong>Designation:</strong> <?php echo esc_html($desig); ?></span>
                    </div>
                <?php endif; ?>
                ...
                <?php if($role): ?>
                    <div class="contact-item">
                        ...
                        <span><strong>Group:</strong> <?php echo esc_html($role); ?></span>
                    </div>
                <?php endif; ?>
        ...
        <article class="profile-content">
            ...
            <div class="profile-role"><?php echo $desig ? esc_html($desig) : ''; ?></div>
